...
$GLOBALS['TL_DCA']['tl_dynamicregion_archive'] = array
(
	// Config
	'config' => array
	(
		'dataContainer'               => DC_Table::class,
		'ctable'                      => array('tl_dynamicregion_item','tl_content'),
		'switchToEdit'                => true,
		'enableVersioning'            => true,
		'markAsCopy'                  => 'title',
		'onload_callback' => array
		(
			array('tl_dynamicregion_archive', 'adjustDca')
		),
		'oncreate_callback' => array
		(
			array('tl_dynamicregion_archive', 'adjustPermissions')
		),
		...
		(
			array('tl_dynamicregion_archive', 'addSitemapCacheInvalidationTag'),
		),
		'sql' => array
		(
			'keys' => array
	...
	(
		...
		(
			...
			(
				'icon'                => 'article.gif',
				'label'               => ['See regions','See regions'],
				'href'                => 'table=tl_dynamicregion_item',
			),
            'content-items' => array
			(
				'icon'                => 'children.gif',
				'label'               => ['Edit content elements','Edit Content Elements'],
 ...
 * @internal
 */
class tl_dynamicregion_archive extends Backend
{
	/**
	 * Set the root IDs.
	 */
	public function adjustDca()
	{
		...
		$GLOBALS['TL_DCA']['tl_dynamicregion_archive']['list']['sorting']['root'] = $root;
	}
	...
	public function adjustPermissions($insertId)
	{
		...
		if (is_array($arrNew['tl_dynamicregion_archive']) && in_array($insertId, $arrNew['tl_dynamicregion_archive']))
		{
